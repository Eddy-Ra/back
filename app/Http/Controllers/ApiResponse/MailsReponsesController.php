...
class MailsReponsesController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validator = Validator::make($request->all(), [
            'expediteur' => 'sometimes|string',
            'sujet' => 'sometimes|string',
            'contenu' => 'sometimes|string',
            'mailOriginal' => 'sometimes|string',
            'statut' => 'sometimes|string',
            'dateReponse' => 'sometimes|string',
        ...
        ])->post("{$this->supabaseUrl}/rest/v1/b2b_mailsreponses", $data);
    ...
    public function update(Request $request, $id)
    {
        ...
        $response = Http::withoutVerifying() // 👈 manque ici !
            ...
            'Content-Type' => 'application/json',
            'Prefer' => 'return=representation',
        ])->patch("{$this->supabaseUrl}/rest/v1/b2b_mailsreponses?id=eq.$id", $data);
    ...
    public function destroy($id)
    {
        $response = Http::withoutVerifying() // 👈 manque ici !
            ...
            'Authorization' => 'Bearer ' . $this->supabaseKey,
            'Content-Type' => 'application/json',
        ])->delete("{$this->supabaseUrl}/rest/v1/b2b_mailsreponses?id=eq.$id");
