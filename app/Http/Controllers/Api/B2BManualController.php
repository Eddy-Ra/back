...
class B2BManualController extends Controller
{
    private $supabaseUrl;
    private $supabaseKey;
    ...
    public function index()
    {
        ...
        ])->get("{$this->supabaseUrl}/rest/v1/b2b_manual", [
            'select' => '*',
    ...
    public function store(Request $request)
    {
        ...
        ])->post("{$this->supabaseUrl}/rest/v1/b2b_manual", $data);
    ...
    public function update(Request $request, $id)
    {
        ...
        $response = Http::withoutVerifying() // 👈 manque ici !
            ...
            'Content-Type' => 'application/json',
            'Prefer' => 'return=representation',
        ])->patch("{$this->supabaseUrl}/rest/v1/b2b_manual?id=eq.$id", $data);
    ...
    public function destroy($id)
    {
        $response = Http::withoutVerifying() // 👈 manque ici !
            ...
            'apikey' => $this->supabaseKey,
            'Authorization' => 'Bearer ' . $this->supabaseKey,
        ])->delete("{$this->supabaseUrl}/rest/v1/b2b_manual?id=eq.$id");
