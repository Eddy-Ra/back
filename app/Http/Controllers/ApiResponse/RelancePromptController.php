...
class RelancePromptController extends Controller
{
    ...
    public function index()
    {
        ...
        ])->get("{$this->supabaseUrl}/rest/v1/relance-prompt", [
            'select' => '*',
            'order' => 'id.desc',
        ]);
    ...
    public function store(Request $request)
    {
        ...
        ])->post("{$this->supabaseUrl}/rest/v1/relance-prompt", $data);
    ...
    public function update(Request $request, $id)
    {
        ...
        $response = Http::withoutVerifying() // 👈 manque ici !
            ...
            'Content-Type' => 'application/json',
            'Prefer' => 'return=representation',
        ])->patch("{$this->supabaseUrl}/rest/v1/relance-prompt?id=eq.$id", $data);
    ...
    public function destroy($id)
    {
        $response = Http::withoutVerifying() // 👈 manque ici !
            ...
            'Authorization' => 'Bearer ' . $this->supabaseKey,
            'Content-Type' => 'application/json',
        ])->delete("{$this->supabaseUrl}/rest/v1/relance-prompt?id=eq.$id");
